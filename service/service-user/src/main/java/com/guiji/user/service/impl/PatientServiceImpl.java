...
import com.guiji.cmn.client.DictFeignClient;
import com.guiji.enums.DictEnum;
import com.guiji.model.user.Patient;
import com.guiji.user.mapper.PatientMapper;
...
public class PatientServiceImpl extends ServiceImpl<PatientMapper, Patient> implements PatientService {
    ...
    @Override
    public String returnValue(String dictCode, String value){
        return dictFeignClient.getName(dictCode, value);
    }
